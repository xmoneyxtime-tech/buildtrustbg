...
export default function EditProfilePage() {
  ...
  return (
    <DashboardShell
      role="company"
      title="Edit Profile"
      subtitle="Редактирайте основни данни за компанията, градовете и услугите."
    >
      <Panel title="Основни данни" description="Поддържайте профила си актуален за по-добро представяне в каталога.">
